...
2. **Configure API URL (optional):**
   Create a `.env` file:
   ```env
   VITE_API_URL=https://autoassist.com.my/api
   ```
...
3. **Start development server:**
   ...
   The dashboard will open at `https://autoassist.com.my/admin`
...
The dashboard connects to the backend API at `https://autoassist.com.my/api` by default. Make sure the backend server is running before using the dashboard.
